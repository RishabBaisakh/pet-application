...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-blue-500 p-4 md:h-64">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <div className="flex">
            ...
            <Link
              href="/signup"
              className="flex ml-4 items-center gap-5 self-start rounded-lg bg-amber-500 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-blue-400 md:text-base">
              <span>Sign up</span>
            </Link>
          </div>
        </div>
