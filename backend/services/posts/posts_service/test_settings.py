...
Posts service uses JWTStatelessUserAuthentication — no User model needed.
"""

from datetime import timedelta

SECRET_KEY = "test-secret-key-for-posts-testing-only-do-not-use-in-production"
DEBUG = True
ALLOWED_HOSTS = ["*"]
...
SIMPLE_JWT = {
    "SIGNING_KEY": "test-jwt-secret-for-posts-testing-only",
    "ALGORITHM": "HS256",
